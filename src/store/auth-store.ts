    ...
    try {
      ...
      if (targetUser?.sellerInfo) {
        ...
        await addShop({
          ...
          coverImage: info.coverImage || "https://images.unsplash.com/photo-1500937386664-56d1dfef3854?w=600&h=400&fit=crop",
          verified: true,
          rating: 5.0,
          reviewCount: 0,
          productCount: 0,
  ...
  updateSellerInfo: async (info) => {
    ...
    try {
      ...
      await updateShop(currentUser.id, {
        ...
        coverImage: uploadedInfo.coverImage || "https://images.unsplash.com/photo-1500937386664-56d1dfef3854?w=600&h=400&fit=crop",
