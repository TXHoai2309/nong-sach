...
export default function CartBadge() {
  ...
  return (
    <Link
      ...
      className="relative flex items-center gap-2 text-[#3c4a42] hover:bg-[#10b981]/10 px-2 py-2 rounded-full transition-all"
    >
      <span className="material-symbols-outlined text-[24px]">shopping_cart</span>
      <span className="hidden lg:inline text-[14px] leading-[20px]">Giỏ hàng</span>
